...
public class FormTextField extends java.awt.TextField implements FormInterface{
	...
	* Note: This method should always replicate initialize(...);
	*/
	@Override
	public void save(Save save){
		save.println("form.comp.FormTextField");
